...
class PlayerController extends Controller {
     ...
     * @return mixed
     */
    public function managePlayerFromBC() {
        ...
        */
        if($totalPlayers > 0) {
            ...
            return redirect('/admin/dashboard')->with('status', Lang::get('messages.player_not_found'));
        }

        return redirect('/admin/dashboard')->with('status', Lang::get('messages.managed_player'));
    }
