...
class VideoController extends Controller {
    ...
    /**
     * Execute the manage command manually form backend;
     *
     * @return mixed
     */
        ...
        */
        if($totalVideos > 0) {
            ...
            for($i=0; $i<$totalVideos; $i++) {
                ...
                $this->conditionOnVideoAddition( $request, $video_data);
            }
        ...
        return redirect('/admin/dashboard')->with('status', Lang::get('messages.managed_video'));
	}

	/*
        check conditions like: slug, name and id
    */
    private function conditionOnVideoAddition( $request, $data ) {
