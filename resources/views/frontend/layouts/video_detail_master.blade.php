...
<body>
	...
	<script type="text/javascript" src="{{ asset( 'frontend/js/video.js' ) }} defer="defer"" defer="defer"></script>
	<script type="text/javascript" src="{{ asset( 'frontend/js/slick.min.js' ) }} defer="defer"" defer="defer"></script>
