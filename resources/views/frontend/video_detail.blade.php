	...
	@section('content')
      	...
      	<div class="container-fluid px-0">
            ...
            <li>
            	<a href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo URL::current(); ?>&title={{ $video_detail['name'] }}&summary={{ $video_detail['description'] }}&source=TheMoneyMile" target="_blank">
