	...
	@section('content')
      	...
      	<div class="container-fluid px-0">
            ...
            <li>
              <a target="_blank" href="fb-messenger://share/?link=<?php echo URL::current(); ?>&app_id=356489725165043" class="fb-xfbml-parse-ignore d-lg-none d-xl-none">                <img src="{{ asset( 'frontend/images/social/messenger.png' ) }}" alt="Messenger Share" title="Messenger Share" />              </a>
            </li>
            <li>
              <a href="#shareArticle?mini=true&url=<?php echo urlencode( URL::current() ) ?>" target="_blank">
